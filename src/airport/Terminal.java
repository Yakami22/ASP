...
public class Terminal {
    ...
    public void acceptPlane(Airplane airplane) {
        ...
        // Make landing & entry lane available
        airplane.getEntryLane().setAvailable(true);
        this.getAirport().setLandingLaneAvailable(true);
        Logger.Information(this, "acceptPlane", "Terminal " + this.id + " accepted plane " + airplane.getId());
        Logger.Information(this, "acceptPlane", "Landing & entry lane " + airplane.getEntryLane().getId() + " are now available");
        // Set plane id to 0
        airplane.setId(0);
    }
